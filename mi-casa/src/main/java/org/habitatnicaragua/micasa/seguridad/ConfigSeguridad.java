	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
			...
			.authorizeRequests()
				...
				.antMatchers("/gestion/proyectoForm.xhtml").hasAnyRole(Rol.ADMIN.name(), Rol.ADMIN_TECNICO.name(), Rol.TECNICO.name())
				.antMatchers("/gestion/proyectos.xhtml").hasAnyRole(Rol.ADMIN.name(), Rol.ADMIN_TECNICO.name(), Rol.TECNICO.name())
