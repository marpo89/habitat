...
@Named("videoLocalVista")
@ViewScoped
@Getter
@Setter
public class VideoLocalVista extends ControladorBaseUno {
	...
	public void init() {
		...
		if(archivo!=null && !archivo.isArchivoTipoVideo()) {
			archivo=null;
	...
	public String getRutaVideo() {
		...
		if(getHttpServletRequest().getLocalPort()==8090) {
			return "http://localhost/static" + archivo.getRuta();
		}
		
		return getHttpServletRequest().getContextPath() + "/static" + archivo.getRuta();
	}
